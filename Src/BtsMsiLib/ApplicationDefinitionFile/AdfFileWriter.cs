...
namespace BtsMsiLib.ApplicationDefinitionFile
{
    public class AdfFileWriter
    {
        ...
        {
            var propertyNodes = GetPropertyNodes(btsApplication.Name, btsApplication.Description, btsApplication.ProductVersion, btsApplication.Manufacturer);
        ...
        private static void SetFileResourceNodes(List<PropertyNode> propertyNodes, Resource resource, string location, string dateText, List<FileNode> fileNodes)
        {
            propertyNodes.Add(new PropertyNode { Name = "SourceLocation", Value = Path.Combine(location, Path.GetFileName(resource.FilePath)) });
            propertyNodes.Add(new PropertyNode
            {
        ...
        private IEnumerable<PropertyNode> GetPropertyNodes(string displayName, string description, string version, string manufacturer)
        {
            var propertyElements = new List<PropertyNode>
            {
                ...
                new PropertyNode {Name = "Manufacturer", Value = manufacturer},
